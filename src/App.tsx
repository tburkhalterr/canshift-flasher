      ...
      <footer className="flex flex-wrap items-center justify-between gap-2 border-t border-border px-4 py-2 text-xs text-text-muted sm:px-6">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="tburkhalterr/canshift-flasher repository on GitHub (opens new tab)"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label={`View build commit ${BUILD_SHA} on GitHub (opens new tab)`}
          className="inline-flex items-center gap-1 font-mono underline-offset-4 hover:text-text hover:underline"
